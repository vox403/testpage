...
<hr class="memo-divider">
    ...
    function mailVisibleItems(){
      ...
      return birthdayMail ? [birthdayMail, ...items] : items;
    }
    ...
    function directSecretaryPanelHtml(){
      ...
      return `
        <article class="voc-answer-card voc-admin-request-card">
          ...
          <dl>
            <dt>직원 ID</dt>
            <dd><input id="directSecretaryEmployeeIdInput" class="search-input" type="text" autocomplete="off" placeholder="예: VT-992773"></dd>
            <dt>표시명</dt>
            <dd><input id="directSecretaryEmployeeNameInput" class="search-input" type="text" autocomplete="off" placeholder="선택 입력"></dd>
          </dl>
          <div class="voc-admin-request-actions">
            <button id="directSecretaryAddBtn" class="voc-approve-request" type="button">목록 추가</button>
          </div>
          <div class="voc-answer-meta">직원 ID 입력칸에 “VT-992773 Ethan”처럼 한 번에 적어도 자동으로 분리됩니다.</div>
        </article>
        ${staffCards}
      `;
    }
